package com.hyz.douyin.favorite.job.one;
...
//        return mongoTemplate.collectionExists(collectionName) ? "创建视图成功" : "创建视图失败";
    ...
    public void run(String... args) {
        String name = FavoriteConstant.FAVORITE_COLLECTION_NAME;
        boolean result = createCollection(name);
        log.info("mongo 集合初始化，集合名称：【" + name + "】，初始化结果：" + result);
    }
}
